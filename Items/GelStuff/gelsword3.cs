...
{
	public class gelsword3 : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Gel Kodachi");
			Tooltip.SetDefault("Don't touch the pointy side. It hurts a lot...\nRight-click for stab attack.");
		}
		public override void SetDefaults()
		{
			...
			item.value = 900000;           //The value of the weapon
