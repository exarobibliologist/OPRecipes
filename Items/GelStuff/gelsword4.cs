...
{
	public class gelsword4 : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Gel Odachi");
			Tooltip.SetDefault("Sharp enough to cut butter...\nRight-click for stab attack.");
		}
		public override void SetDefaults()
		{
			item.damage = 270;           //The damage of your weapon
			...
			item.value = 2700000;           //The value of the weapon
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(mod.ItemType("gelsword3"), 3);
			recipe.AddIngredient(ItemID.Gel, 50); // It's a gooey mess.
			recipe.AddIngredient(ItemID.PinkGel, 30); // It's a gooey mess.
			recipe.AddTile(TileID.WorkBenches);
			recipe.SetResult(this);
			recipe.AddRecipe();
			
			recipe = new ModRecipe(mod);
			recipe.AddIngredient(mod.ItemType("Boomerang4"), 1);
            recipe.SetResult(this); //
            recipe.AddRecipe();
		}
		...
		public override void OnHitNPC(Player player, NPC target, int damage, float knockBack, bool crit)
		{
			if (player.altFunctionUse == 2)
			{
				...
				target.AddBuff(BuffID.Frostburn, 40);
